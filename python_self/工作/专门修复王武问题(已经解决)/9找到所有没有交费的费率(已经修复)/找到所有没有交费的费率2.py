                        ...
                        if minDate.month != maxDate.month :
                            ...
                            for result in results:
                                ...
                                for mobile in mobiles:
                                    phone=mobile["mobile"]
                                    if amount % 100 != 0:
                                        #print("源账户=" + str(srcUser) +",mobile:"+phone+ ",应扣amount=" + str(amount / 100) + ",费用名称=" + feeName + ",已扣" + str(amount // 100) + ",待扣" + str(amount % 100)+"分")
                                        #print(str.format("%s,%s,【%s】还款费用解冻" % (phone,str(amount % 100),assetName)))
                                        print(str.format("%s,platform,%s,【%s】还款费用划拨,费用名称:%s" % (phone,str(amount % 100),assetName,feeName)))
